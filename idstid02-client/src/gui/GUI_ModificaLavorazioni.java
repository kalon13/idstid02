...
public class GUI_ModificaLavorazioni {
	...
	private void initialize() {
		...
		btnInserisci.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(verificaPrezzoIns(txtPrezzo.getText()) && verificaCapacitaIns(txtCapacita.getText())){
					...
					//Verifichiamo che il terzista non abbia gi� questa lavorazione
					...
					if(!presente){//Non ha gi� questa lavorazione
						...
						JOptionPane.showMessageDialog(null, "Inserimento negato. Hai gi� questa lavorazione.", "Attenzione", 0);
				}
			}
		});
		...
		table_2.getActionMap().put("UPDATE", new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent evt) {
                //UPDATE LAVORAZIONE
            	//Il vettore delle righe � idLav_1
		...
		table_3.getActionMap().put("UPDATE", new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent evt) {
                //UPDATE FASE
            	//Il vettore delle righe � idLav_2
	...
	public boolean verificaCapacitaIns(String c){
		try{
			...
			JOptionPane.showMessageDialog(null, "Capacit� non corretta!", "Attenzione", 0);
			return false;
		}
	}
