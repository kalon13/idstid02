...
public class GUI_ModificaLavorazioni {
	...
	private void initialize() {
		...
		btnInserisci.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(verificaPrezzoIns(txtPrezzo.getText()) && verificaCapacitaIns(txtCapacita.getText())){
					...
					//Verifichiamo che il terzista non abbia gia' questa lavorazione
					...
					if(!presente){//Non ha gia' questa lavorazione
						...
						JOptionPane.showMessageDialog(null, "Inserimento negato. Hai gia' questa lavorazione.", "Attenzione", 0);
				}
			}
		});
		...
		table_2.getActionMap().put("UPDATE", new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent evt) {
                //UPDATE LAVORAZIONE
            	//Il vettore delle righe e' idLav_1
            	...
            	if(!lavorazioneAperta){
            		...
            		if(table_2.getValueAt(table_2.getSelectedRow(), 1)!=null && table_2.getValueAt(table_2.getSelectedRow(), 2)!=null){
            			if(Double.parseDouble(p)>0 && Float.parseFloat(c)>0){
            				...
            				JOptionPane.showMessageDialog(null, "Prezzo o capacita' non corretti.", "Attenzione", 0);
            		}
            		else
		...
		table_3.getActionMap().put("UPDATE", new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent evt) {
                //UPDATE FASE
            	//Il vettore delle righe e' idLav_2
	...
	public boolean verificaCapacitaIns(String c){
		try{
			...
			JOptionPane.showMessageDialog(null, "Capacita' non corretta!", "Attenzione", 0);
			return false;
		}
	}
