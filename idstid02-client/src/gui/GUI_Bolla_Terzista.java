...
public class GUI_Bolla_Terzista {
        ...
        public DefaultTableModel dmPrima = new DefaultTableModel(
                ...
                new String[] {
                                "Descrizione", "Quantit�", "udm", "Num.Morti", "Q.ta Prodotta", "Q.ta Spedita"
                })
                {
		...
		public DefaultTableModel dm = new DefaultTableModel(
                ...
                new String[] {
                                "Descrizione", "Quantit�", "udm", "Costo Unitario",
                })
        {
...
//        }
        ...
        private void initialize() {
            ...
            panel_1.add(btnVisualizzaExtra);
             ...
             btnRichiedi.addActionListener(new ActionListener() {
            	@Override
            	public void actionPerformed(ActionEvent e) {
            		if (!txtQuantitaExtra.getText().isEmpty()){ //se il campo con la quantit� da richiedere non � vuota
            			if (verificaQuantitaIns(txtQuantitaExtra.getText())){ //Controllo se ho inserito una quantit� double
            		...
            		else
            		{
            			JOptionPane.showMessageDialog(frmBolleDiLavorazioneTerzista,
            				    "Selezionare un materiale teorico e inserire una quantit�!!",
            				    "Attenzione!",
            ...
            //Se cerco di annullare una bolla gi� iniziata -> errore!
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                else //se la bolla non � stata ancora iniziata pu� essere annullata
                {
            	...
            	public void actionPerformed(ActionEvent e) {
            		int result = JOptionPane.showConfirmDialog(frmBolleDiLavorazioneTerzista, "Si vuole confermare la chiusura parziale della bolla e l'invio del DDT all'azienda?");
              	   	if(JOptionPane.YES_OPTION == result){
              	   		if (verificaChiusura()){
              	   		JOptionPane.showMessageDialog(frmBolleDiLavorazioneTerzista,
             				    "La bolla � pronta per essere chiusa! [Chiudi bolla]",
             				    "Attenzione!",
             				    JOptionPane.PLAIN_MESSAGE);
              	   		}
              	   		else{
                          ...
                          b.setTerzistaId(terzista.getId()); //idTerzista (perch� su InsUpd ho messo due parametri!!!!!!!!!)
                          ResourceClass.updResources(Bolla.class, Global._URLBollaStato, String.valueOf(id), b);
                          listModel.removeAllElements(); //pulisce la lista delle bolle del terzista
                          caricaJListBolle(terzista.getId()); //ricarica la lista delle bolle del terzista
                          dm.setRowCount(0); //pulisce la table_1 (dm = datamodel della table_1)
            ...
            btnChiudiBolla.addActionListener(new ActionListener() {
            	...
            	int result = JOptionPane.showConfirmDialog(frmBolleDiLavorazioneTerzista, "Si vuole confermare la chiusura della bolla e l'invio del DDT all'azienda?");
             	   if(JOptionPane.YES_OPTION == result){
                     ...
                     else //se la bolla non � stata ancora chiusa
                     {
                       if(verificaChiusura()){
                         Bolla b = new Bolla();
                         if (numMorti != 0)
                       ...
                       {
                    	   JOptionPane.showMessageDialog(frmBolleDiLavorazioneTerzista,
                				    "La quantit� prodotta deve essere uguale alla quantit� totale meno i morti!",
                				    "Attenzione!",
                				    JOptionPane.PLAIN_MESSAGE);
                       }
                      }
            ...
            public void tableChanged(TableModelEvent e) {
                ...
                if(col > 2) {
                    ...
                    if (qtp > qta){ //se inserisco una quantit� prodotta maggiore di quella richiesta errore
            			JOptionPane.showMessageDialog(frmBolleDiLavorazioneTerzista,
            				    "Campo quantit� prodotta errato!",
            				    "Attenzione!",
            				    JOptionPane.PLAIN_MESSAGE);
                    	...
                    	JOptionPane.showMessageDialog(frmBolleDiLavorazioneTerzista,
            				    "Campo quantit� prodotta deve essere maggiore a " + qtpPrec + "!",
            				    "Attenzione!",
            				    JOptionPane.PLAIN_MESSAGE);
                    	loadTableMatDaProdurre1(id);
                    }
                        ...
                        //Se il materiale � presente -> modifico la quantit� altimenti -> inserisco
    ...
    public int selezionaRiga(){
		...
		private boolean verificaChiusura(){ //quando chiudo la bolla verifico che la quantit� totale corrisponda alla quantit� prodotta + numero dei morti
			Iterator<MaterialeDaProdurre> it = listaMDaProd1.iterator();
			boolean flg = true;
            while(it.hasNext())
            {                      
