...
public class GUI_DatiTerzistaTr {
	...
	private void initialize() {
		...
		frmDatiTerzista.setBounds(100, 100, 582, 463);
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"Lavorazione", "Fase", "Capacit\u00E0", "Prezzo", "Media Qualit\u00E0"
			}
		));
		...
		lblFase.setFont(new Font("Tahoma", Font.BOLD, 11));
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
							...
							.addGroup(Alignment.TRAILING, groupLayout.createSequentialGroup()
								.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
									.addComponent(table, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 535, Short.MAX_VALUE)
									.addGroup(groupLayout.createSequentialGroup()
										.addComponent(lblLavorazione)
										.addPreferredGap(ComponentPlacement.RELATED, 91, Short.MAX_VALUE)
										.addComponent(lblFase, GroupLayout.PREFERRED_SIZE, 69, GroupLayout.PREFERRED_SIZE)
										.addGap(18)
